                            ...
                            <div class="card-body">
                                ...
                                @endif
                                    ...
                                    <div class="pt-2">
                                        ...
                                        <form class="form-horizontal mt-2" method="post"  action="{{route('callCenter.form.edit')}}">
                                            @csrf
                                            ...
                                            <div class="col-6">
                                                <div class="form-group text-right">
                                                    ...
                                                    <select class="form-control" name="Connection_Status" id="Connection_Status">
                                                        <option value="{{$member->ConnectionStatus}}">{{$member->ConnectionStatus}}</option>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group text-right">
                                                    ...
                                                    <input type="text" class="form-control text-right" name="Date_of_Birth" value="{{$member->DateofBirth}}" id="Date_of_Birth" placeholder="{{__('page.Date_of_Birth')}}">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group text-right">
                                                    ...
                                                    <input type="text" class="form-control text-right" name="age" id="age" value="{{$member->age}}" placeholder="{{__('page.Age')}}">
                                                </div>
                                            </div>
                                            ...
                                            @else
                                                <div class="col-6">
                                                    <div class="form-group text-right">
                                                        ...
                                                        <select class="form-control" name="City" id="city_select" onchange="cityChange()">
                                                            <option value="الرياض">{{__('page.Riyadh')}}</option>
                                                            <option value="خارج الرياض" selected>{{__('page.Outside_Riyadh')}}</option>
                                                        </select>
                                                        <div id="cityOther">
                                                            <input type="text" class="form-control text-right mt-1" name="cityOther" id="" value="{{$member->City}}" placeholder="{{__('page.Other')}}">
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif

                                            @if($member->answer == 'نعم')
                                                <div class="col-6">
                                                    <div class="form-group text-right">
                                            ...
                                            @else
                                                <div class="col-6">
                                                    <div class="form-group text-right">
                                                        ...
                                                        <div id="answerOther">
                                                            <input type="text" class="form-control text-right mt-1" value="{{$member->answer}}" name="answerOther" id="" placeholder="السبب">
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif

                                            @if($member->healthProblem == 'لا')
                                                <div class="col-6">
                                                    <div class="form-group text-right">
                                            ...
                                            @else
                                                <?php
                                                    $healthProblemm = explode("-", $member->healthProblem);
                                                    ?>
                                                <div class="col-6">
                                                    <div class="form-group text-right">
                                                        <label for="problem_select">هل تعاني من أي مشاكلة صحية</label>
                                                        ...
                                                        <div id="problemOtherDiv">
                                                            <select class="form-control" name="healthProblem" id="problemOther_select" onchange="problemSelectOther()">
                                                                <option value="{{$healthProblemm[1]}}">{{$healthProblemm[1]}}</option>
                                                                @foreach($healthProblems as $healthProblem)
                                                                    <option value="{{$healthProblem->name}}">{{$healthProblem->name}}</option>
                                                                @endforeach
                                                                <option value="اخري">{{__('page.Other')}}</option>
                                            ...
                                            @else
                                                    <?php
                                                    $chronicc = explode("-", $member->chronic);
                                                    ?>
                                                <div class="col-6">
                                                    <div class="form-group text-right">
                                                        <label for="problem_select">هل تعاني من أي مرض مزمن</label>
                                                        ...
                                                        <div id="chronicOtherDiv">
                                                            <select class="form-control" name="chronic" id="chronicOther_select" onchange="chronicSelectOther()">
                                                                <option value="{{$chronicc[1]}}">{{$chronicc[1]}}</option>
                                                                @foreach($chronicDiseases as $chronicDisease)
                                                                    <option value="{{$chronicDisease->name}}">{{$chronicDisease->name}}</option>
                                                                @endforeach
                                                                <option value="اخري">{{__('page.Other')}}</option>
                                            ...
                                            @else
                                                    <?php
                                                    $disabilityy = explode("-", $member->disability);
                                                    ?>
                                                <div class="col-6">
                                                    <div class="form-group text-right">
                                                        <label for="problem_select">هل تعاني من أي إعاقة</label>
                                                        ...
                                                        <div id="disabilityOtherDiv" style="display: none">
                                                            <select class="form-control" name="disabilityOther_select" id="disabilityOther_select" onchange="disabilitySelectOther()">
                                                                <option value="{{$disabilityy[1]}}">{{$disabilityy[1]}}</option>
                                                                @foreach($Disabilities as $Disability)
                                                                    <option value="{{$Disability->name}}">{{$Disability->name}}</option>
                                                                @endforeach
                                                                <option value="اخري">{{__('page.Other')}}</option>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group text-right">
                                                    ...
                                                    <select class="form-control" name="checkedHospital_select" id="checkedHospital_select" onchange="checkedHospitalChange()">
                                                        <option value="{{$member->Hospital}}">{{$member->Hospital}}</option>
                                                        <option value="لا">لا</option>
                                                        <option value="نعم">نعم</option>
                                                    </select>
                                                ...
                                                @else
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-group text-right">
                                                            ...
                                                            <div id="helpOther">
                                                                <input type="text" class="form-control text-right mt-1" value="{{$helpp[1]}}" name="helpOther" id="" placeholder="المساعده/السبب">
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endif
                                            ...
                                            <div class="col-6">
                                                <div class="form-group text-right">
                                                    ...
                                                    <select class="form-control" name="centerArea" id="getcenterNames" onchange="getcenterNamesSelect()">
                                                        <option value="{{$member->centerArea}}">{{$member->centerAreaname->name}}</option>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group text-right">
                                                    ...
                                                    <input type="text" class="form-control text-right" value="{{$member->day}}" name="day" id="day">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group text-right">
                                                    ...
                                                    <input type="date" class="form-control text-right" value="{{$member->date}}" name="date" id="date">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group text-right">
                                                    ...
                                                    <input type="time" class="form-control text-right" value="{{$member->time}}" name="time" id="time">
                                                </div>
                                            </div>
                                ...
                                <div id="center_area_real_input">
                                 ...
                                 <div id="Hospital_name_real">
                                        ...
                                        <input type="hidden" name="event_id" value="{{$member->event->id}}">


                                            <div class="form-group row mt-2">
                                                <div class="col-sm-12 text-center">
                                                    <button class="btn btn-primary w-md waves-effect waves-light" type="submit">{{__('page.Update')}}</button>
                                                </div>
                                            </div>
                                        </form>
