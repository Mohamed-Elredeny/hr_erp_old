...
{{--            <h4 class="logo-text">Dashkote</h4>--}}
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            <a href="{{route('callCenter.events')}}">
                <div class="parent-icon">
                    <img src="{{asset('assets/admin/images/icons/gift.png')}}" style="width: 30px">
                </div>
                <div class="menu-title">{{__('page.Projects')}}</div>
            </a>
        </li>

        <li>
            <a href="{{route('callCenter.pending')}}">
                <div class="parent-icon">
                    <img src="{{asset('assets/admin/images/icons/50.png')}}" style="width: 30px">
                </div>
                <div class="menu-title">{{__('page.Orders_Pending')}}</div>
            </a>
        </li>

        <li>
            <a href="{{route('callCenter.delivered')}}">
                <div class="parent-icon">
        ...
        <li>
            <a href="{{route('callCenter.canceled')}}">
                <div class="parent-icon">
                    <img src="{{asset('assets/admin/images/icons/cancel.jpg')}}" style="width: 30px">
                </div>
                <div class="menu-title">{{__('page.Orders_Canceled')}}</div>
            </a>
        </li>
