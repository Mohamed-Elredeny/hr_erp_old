...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <a href="{{route('admin.export.pending')}}" type="button" class="btn btn-primary px-4">
            ...
            <div class="card mt-4">
                <div class="card-body" id="orders">
                    ...
                    <div class="table-responsive">
                        <a href="{{route('admin.delete.state',['state'=>'قيد الانتظار'])}}" type="button" class="btn btn-primary px-4">
                            {{__('page.Delete_All')}}
                        </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3 fs-6">
                                        <a href="{{route('admin.update.form',['id'=>$pending->id])}}" class="btn btn-primary" >
                                            {{__('page.Update')}}
                                        </a>
                                            ...
                                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center">
                                                        <form method="post" action="{{route('admin.request.event.send.whats',['id'=>$pending->id])}}" enctype="multipart/form-data">
                                                            @csrf
...
{{--                                                            {!! QrCode::size(200)->generate(route('request.event.store',['id'=>$pending->id])) !!}--}}
                                        ...
                                        <a href="{{route('admin.request.canceled',['id'=>$pending->id])}}" class="btn btn-primary">
                                            {{__('page.Cancel')}}
                                        </a>
