...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <a href="{{route('admin.export.delivered')}}" type="button" class="btn btn-primary px-4">
                ...
                <div class="card-body" id="orders">
                    <form method="post" action="{{route('admin.delete')}}" enctype="multipart/form-data">
                        ...
                        <div class="table-responsive">
                            <a href="{{route('admin.delete.state',['state'=>'تم الاستلام'])}}" type="button" class="btn btn-primary px-4">
                                {{__('page.Delete_All')}}
                            </a>
