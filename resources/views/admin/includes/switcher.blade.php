    ...
    <div class="offcanvas offcanvas-end shadow border-start-0 p-2" data-bs-scroll="true" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling">
        ...
        <div class="offcanvas-body">
            ...
            <div class="form-check form-check-inline">
                ...
                <label class="form-check-label" for="DarkTheme">غامق</label>
            </div>
            <div class="form-check form-check-inline">
                <input class="form-check-input" type="radio" name="inlineRadioOptions" id="SemiDark" value="option3" checked>
                <label class="form-check-label" for="SemiDark">شبة غامق</label>
            </div>
            <hr/>
            <h6 class="mb-0">ألوان الشريط الأعلى</h6>
            <hr/>
