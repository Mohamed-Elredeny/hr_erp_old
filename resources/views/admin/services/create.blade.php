                ...
                <div class="card-body">
                    <form method="post" action="{{route('admin.services.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <input class="form-control mb-3" type="text" name="name" placeholder="{{__('اسم الخدمة')}}"required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-10">
                                <textarea class="form-control mb-3" name="new_solutions" ></textarea>
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-2">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-10">
                                <input type="file" accept="image/*" class="form-control" name="cover" id="inputGroupFile02" required>
                            </div>
                        </div>
