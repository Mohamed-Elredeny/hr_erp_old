    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            <form class="form d-flex flex-column flex-lg-row"
                  action="{{route('admin.leavesTypes.update',['leavesType'=>$leave_type->id])}}" method="POST">
                @csrf
                @method('put')
                            ...
                            <div class="card-body pt-0 ">
                                <div class=" fv-row row">
                                    <div class="col-sm-12">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" class="form-control" value="{{$leave_type->name}}" required name="name">
                                    </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="number" class="form-control" value="{{$leave_type->quantity}}" required name="quantity">
                                    </div>
