                ...
                <div class="card-body" id="orders">
                    <div class="table-responsive">
                        <table id="example" class="table table-bordered align-middle text-center" style="width:100%">
                            ...
                            <tr>
                                <th>#</th>
                                <th>{{__('اسم المشروع')}}</th>
                                <th>{{__('لوجو المشروع ')}}</th>
                                <th>{{__('رابط المشروع')}}</th>
                                <th>{{__('تفاصيل المشروع')}}</th>
                                <th>{{__('عرض كمستخدم')}}</th>
                            ...
                            @foreach($projects as $service)
                                <tr style="text-align: center">
                                    ...
                                    <td>
                                        <a href="{{route('admin.projects.edit',['project'=> $service->id] )}}" class="btn btn-primary">
                                            تعديل البيانات
                                        </a>
                                    </td>
                                    <td>
