                ...
                <div class="col-12 mt-3">
                    <table id="" class="table table-bordered dt-responsive nowrap text-left"
                        ...
                        <tr class="m-3 p-3">
                            ...
                            <td style="border: 0px">
                                <input type="radio" class="" onclick="manager_count_select()" name="manager_count" value="1" id="manager_count1" required>
                                <label for="manager_count1">One</label>
                            </td>
                            <td style="border: 0px">
                                <input type="radio" onclick="manager_count_select()" class="" name="manager_count" value="2" id="manager_count2" required>
                        ...
                        <h4 style="color: #3a54a8" class="mt-5">1.	For employee's KPI <span style="text-align: justify; font-weight: 800">(Key Objectives)</span></h4>
                    ...
                    <p>The system permits you to provide an objective description within a maximum of 150 words, with a requirement to set the objectives' weighting at 100%.</p>
                        <table id="" class="table table-bordered dt-responsive nowrap"
                            ...
                            <tr class="text-left">
                                <th style="width: 70px" title="Set a target of at least 3 objectives and avoid exceeding 5 key This careful selection of objectives helps you maintain a focused and achievable direction.">
                                    <b>Obj.
                                ...
                                <th title="Specify how success will be measured. For example, 'Complete Project X by [date]' shows successful attainment">
                                    <b>Results Expected (KPI) <i class="fa fa-exclamation-circle" aria-hidden="true"></i></b>
                                </th>
{{--                                <th>--}}
{{--                                    <b>Target Date</b>--}}
{{--                                </th>--}}
                                ...
                                <th title="When reviewing your objectives consider not only the achievement of the objective but how you achieved it (the values you adhered to).Consider both achievement and the values you followed.">
                                    <b>Comments from Employee <i class="fa fa-exclamation-circle" aria-hidden="true"></i></b>
                                </th>
                                ...
                                <tr>
                                    <th>
                                        <input type="text" class="form-control" name="Objectives_No[]" style="border-color: white; background-color: white" id="Objectives_No" value="1">
                                    </th>
                                    <th>
                                        <textarea class="form-control" name="Objectives_Type[]" id="Objectives_Type" required="required"></textarea>
                                    </th>
                                    <th>
                                        <textarea class="form-control" maxlength = "500" name="Objectives_Objective[]" id="Objectives_Objective" required="required"></textarea>
                                    </th>
                                    <th>
...
{{--                                    </th>--}}
                                    <th>
                                        <textarea class="form-control" name="Objectives_Weighting[]" id="Objectives_Weighting" required="required" onchange="calculatechange()"></textarea>
                                    </th>
                                    <th>
                                ...
                                <tr>
                                    <th>
                                        <input type="text" class="form-control" name="Objectives_No[]" style="border-color: white; background-color: white" id="Objectives_No" value="2" >
                                    </th>
                                    <th>
                                        <textarea class="form-control" name="Objectives_Type[]" id="Objectives_Type" required="required"></textarea>
                                    </th>
                                ...
                                <tr>
                                    <th>
                                        <input type="text" class="form-control" name="Objectives_No[]" style="border-color: white; background-color: white" id="Objectives_No" value="3" >
                                    </th>
                                    <th>
                                        <textarea class="form-control" name="Objectives_Type[]" id="Objectives_Type" required="required"></textarea>
                                    </th>
                        ...
                        <div onclick="ObjectivesClone()" class="btn mart-btn disabled pt-4 mb-4" style="width: 200px !important; opacity: 1 !important;">Add Row</div>
                        ...
                        <div class="ml-5">
                            <input type="radio" class="" name="Objectives_Summary_Rating" value="A-VERY GOOD" id="A-VERYGOOD" required="required" onclick="calculateSum()">
                            <label for="A-VERYGOOD">A-VERY GOOD</label>
                            <br>
                            <input type="radio" class="" name="Objectives_Summary_Rating" value="B-GOOD" id="B-GOOD" required="required" onclick="calculateSum()">
                            <label for="B-GOOD">B-GOOD</label>
                            <br>
                            <input type="radio" class="" name="Objectives_Summary_Rating" value="C-AVERAGE" id="C-AVERAGE" required="required" onclick="calculateSum()">
                            <label for="C-AVERAGE">C-AVERAGE</label>
                            <br>
                            <input type="radio" class="" name="Objectives_Summary_Rating" value="D-BELOW AVERAGE" id="D-BELOWAVERAGE" required="required" onclick="calculateSum()">
                            <label for="D-BELOWAVERAGE">D-BELOW AVERAGE</label>
                            <br>
                            <input type="radio" class="" name="Objectives_Summary_Rating" value="E-UNSATISFACTORY" id="E-UNSATISFACTORY" required="required" onclick="calculateSum()">
                        ...
                        <div class=" mt-5 row">
                            <div class="col-4" id="First_Approval1" style="visibility: hidden">
                                <b >First approval: </b>
                                <input list="First_Approval" name="First_Approval" id="First_Approval_toty" required onchange="set_manager()">
                            ...
                            <div class="col-4" id="First_Approval2" style="visibility: hidden">
                                <b>Final approval: </b>
                                <input list="Final_Approval" name="Final_Approval" id="Final_Approval_toty" onchange="set_manager()">
...
<div class="modal fade" id="Delete11" tabindex="-1" aria-labelledby="exampleModalLabe1l" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content ">
                        ...
                        <div class="modal-body">
                            <p>Are you sure you First approval is <b id="firstapprovel"></b> <span id="finalapprovel"></span></p>
                            <div class="modal-footer">
                                <button type="button" class="btn mart-btn" style="width: 200px !important;" data-dismiss="modal">Cancel</button>
                                <div  onclick="">
                                    <button type="submit" class="btn mart-btn" style="width: 200px !important;">Send Requirement</button>
                                </div>
                        ...
                        <div class="row m-5">
                            <div class="col-sm-12 mt-3 text-center">
                                <button type="button" class="btn mart-btn" style="width: 200px !important;" data-toggle="modal" data-target="#Delete11">
                                    Send Requirement
                                </button>
                            </div>
                        </div>
    ...
    <table class="table table-bordered  text-left" style="background-color: #fff; display: none;">
        ...
        <tbody>
            <tr id="ObjectivesClone2">
                <th>
                    <input type="text" class="form-control" name="Objectives_No[]" style="border-color: white; background-color: white" id="Objectives_No">
                </th>
                <th>
                    <textarea class="form-control" name="Objectives_Type[]" id="Objectives_Type" required="required"></textarea>
                </th>
