        ...
        <div class="container text-center" style="max-width: 85vw;">
            ...
            <div class="row g-4 justify-content-center equal text-justify">
                <div class="col-12">
                        ...
                        <h4 style="color: #3a54a8">1.	For employee's KPI <span style="text-align: justify; font-weight: 800">(Key Objectives)</span></h4>
...
{{--                                    </th>--}}
                    ...
                    @if($kpi[0]->is_first_approval==1)
                    <hr>
                        <h4 style="color: #3a54a8; margin-top:50px">2. For Manager/Supervisor review <span style="text-align: justify; font-weight: 800">(Review)</span></h4>
                        <table id="" class="table table-bordered dt-responsive nowrap text-left"
                        ...
                        <table id="" class="table table-bordered dt-responsive nowrap"
                            ...
                            @for ($x=0; $x < count($Objectives_No); $x++)
                                <tr>
                                    ...
                                    <th>
                                        <input type="radio" class="" name="Review_Manager_Rating{{$x}}" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == "A-VERY GOOD") checked @endif disabled value="A-VERY GOOD" id="A-VERYGOOD" required="required">
                                        <label for="A-VERYGOOD" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == 'A-VERY GOOD') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>A-VERY GOOD</label>
                                        <br>
                                        <input type="radio" class="" name="Review_Manager_Rating{{$x}}" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == "B-GOOD") checked @endif disabled value="B-GOOD" id="B-GOOD" required="required">
                                        <label for="B-GOOD" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == 'B-GOOD') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>B-GOOD</label>
                                        <br>
                                        <input type="radio" class="" name="Review_Manager_Rating{{$x}}" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == "C-AVERAGE") checked @endif disabled value="C-AVERAGE" id="C-AVERAGE" required="required">
                                        <label for="C-AVERAGE" @if(isset($Review_Manager_Rating[$x]) &&  $Review_Manager_Rating[$x] == 'C-AVERAGE') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>C-AVERAGE</label>
                                        <br>
                                        <input type="radio" class="" name="Review_Manager_Rating{{$x}}" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == "D-BELOW AVERAGE") checked @endif disabled value="D-BELOW AVERAGE" id="D-BELOWAVERAGE" required="required">
                                        <label for="D-BELOWAVERAGE" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == 'D-BELOW AVERAGE') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>D-BELOW AVERAGE</label>
                                        <br>
                                        <input type="radio" class="" name="Review_Manager_Rating{{$x}}" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == "E-UNSATISFACTORY") checked @endif disabled value="E-UNSATISFACTORY" id="E-UNSATISFACTORY" required="required">
                                        <label for="E-UNSATISFACTORY" @if(isset($Review_Manager_Rating[$x]) && $Review_Manager_Rating[$x] == 'E-UNSATISFACTORY') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>E-UNSATISFACTORY</label>
                                    </th>
                                    <th>
                    ...
                    @if($kpi[0]->is_final_approval==1)
                    <hr>
                        <h4 style="color: #3a54a8; margin-top:50px">3.	For Manager / Supervisor to review  <span style="text-align: justify; color:#3a54a8; font-weight: 800">(Summary of Overall Performance)</span></h4>
...
<div class="ml-5">
                                    ...
                                    <label for="A-VERYGOOD" @if($kpi[0]->Final_Summary_Rating == 'A-VERY GOOD') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>A-VERY GOOD</label>
                                    <br>
                                    ...
                                    <label for="B-GOOD" @if($kpi[0]->Final_Summary_Rating == 'B-GOOD') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>B-GOOD</label>
                                    <br>
                                    ...
                                    <label for="C-AVERAGE" @if($kpi[0]->Final_Summary_Rating == 'C-AVERAGE') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>C-AVERAGE</label>
                                    <br>
                                    ...
                                    <label for="D-BELOWAVERAGE" @if($kpi[0]->Final_Summary_Rating == 'D-BELOW AVERAGE') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>D-BELOW AVERAGE</label>
                                    <br>
                                    ...
                                    <label for="E-UNSATISFACTORY" @if($kpi[0]->Final_Summary_Rating == 'E-UNSATISFACTORY') style="color:#3a54a8; border: solid 2px #3a54a8; font-weight: 800; padding: 4px" @endif>E-UNSATISFACTORY</label>
                                </div>
                            ...
                            <div class="col-4">
                                ...
                                <p>
                                    <b style="color: #1e7e34" class="">Manager’s Final Rating *</b>
                                    {{$kpi[0]->Final_Summary_Rating}}
                                </p>
                            </div>
                        </div>
                        <div class="mt-4">
