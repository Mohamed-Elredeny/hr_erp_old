...
@keyframes animate
{
  ...
  100%
  {
    ...
    <section class="promo-section pt-100 ">
        <div class="container text-center" style="max-width: 85vw;">
            <div class="text-left">
                <a href="{{route('employee.final_approval')}}" style="font-size:28px;color:#3a54a8"><i class="fa fa-angle-double-left"></i> Back</a>
            </div>
            ...
            <form action="{{route('employee.submitKpiFinalApproval')}}" method="POST" class=""  id="myForm"  enctype="multipart/form-data">
                @csrf
 <input type="hidden" value="{{$kpi[0]->id}}" name="id">
            ...
            <div class="row g-4 justify-content-center equal text-justify mt-4">
                <div class="col-12">
...
<hr>
                    ...
                    <h5 style="color: #3a54a8;" class="mt-5">Summary of Overall First Approval</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <p>
                                <b style="color: #3a54a8;" class="">Manager’s Rating *</b>
...
<div class="modal fade" id="remove" tabindex="-1" aria-labelledby="exampleModalLabelremove" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-lg">
                                        <div class="modal-content ">
                                            ...
                                            <form action="{{route('employee.cancel_final_approval',['id'=>$kpi[0]->id])}}" method="post">
                                                @csrf
