                ...
                <div class="col-md-6 col-lg-6 col-xl-6">
                    <div class="hero-content-left text-white">
                        ...
                        <p class="lead">
                            ...
                            <a class="text-light" href="{{route('employee.final_approval')}}">KPI Final Approval </a> 
                        </p>
                    </div>
                </div>
    ...
    <section class="promo-section pt-100 ">
        <div class="container text-center" style="max-width: 85vw;">
            ...
            <table id="" class="table table-bordered dt-responsive nowrap text-left"
                ...
                <div class="row g-4 justify-content-center mt-4 equal text-justify">
                    <div class="col-12">
                        <h3 style="color: #3a54a8">1.	Key Objectives</h3>
...
{{--                                    </th>--}}
                        ...
                        <small>(Refer to Guide on 1st page and Insert Relevant Number)</small>3a54a8
...
<hr>
 ...
 <hr>
  ...
  <b style="" class="">Overall Performance Rating (Manager to Tick)</b>
                        <div class="row">
                            <div class="col-8">
                                <div class="ml-5">
                            ...
                            <div class="col-4">
                                <p>
                                    <b style="color: #3a54a8" class="">Employee Self Rating *</b>
                                    {{$kpi[0]->Objectives_Summary_Rating}}
                                </p>
                                <p>
                                    <b style="color: #3a54a8" class="">Manager’s First Rating *</b>
                                    {{$kpi[0]->First_Approval_Summary_Rating}}
                                </p>
                                <p>
                                    <b style="color: #3a54a8" class="">Manager’s Final Rating *</b>
