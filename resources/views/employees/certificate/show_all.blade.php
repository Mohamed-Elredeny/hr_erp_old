                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                                ...
                                                <div class="col-9">
                                                    <table id="" class="table table-bordered dt-responsive nowrap text-center"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="" class="font-weight-bold">Date of Joining :</td>
                                                        </tr>
                                                        <tr>
                                                            <td style="">{{$employee->empName}}</td>
                                            ...
                                            <div class="text-left mb-5">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <h3 class="text-center" style="color: #3a54a8">Show Certificate</h3>
                                                        <table id="" class="table table-bordered dt-responsive nowrap text-center"
                                                               style="border-collapse: collapse; border-spacing: 0; width: 100%; border: 5px solid #3a54a8">
                                                            <tr>
                                                                ...
                                                                <td style="" class="font-weight-bold">Show</td>
                                                            </tr>
