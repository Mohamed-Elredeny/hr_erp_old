                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="row container">
                                                <div class="col-12 mb-3" style="border: 5px solid #3a54a8; padding: 20px">
                                                    ...
                                                    <br><br>
                                                    His Gross Salary per month is Qar. <input name="salary" type="text" id="numberInput" value="{{$employee->total_salary}}" required> / <span id="textOutput">{{$employee->salaryText}}</span>.
                                                    <br>
