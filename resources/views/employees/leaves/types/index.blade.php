                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#kt_modal_add_customer">Add New Leave Type
                                    </button>
                                    <!--end::Add customer-->
                                </div>
                                <!--end::Toolbar-->
                                ...
                                @foreach($results as $res)
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            ...
                                            <!--begin::Menu-->
                                            <div
                                                class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 text-center"
                                                data-kt-menu="true">
                                                <!--begin::Menu item-->
                                                <form class="menu-item px-3">
                                                    <a href="{{route('admin.hr.leavesTypes.show',['leavesType'=>$res->id])}}"
                                                       class="btn">View</a>
                                                </form>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <form class="menu-item px-3" method="post"
                                                      action="{{route('admin.hr.leavesTypes.destroy',['leavesType'=>$res->id])}}">
                                                    @method('DELETE')
                                                    @csrf
