                        ...
                        <div class="">
                            <div class="medsm row align-items-left justify-content-between">
                                <div class="col-md-4 col-lg-4 text-left">
                                    <img class="img-fluid d-block" style="width: 290px"
                                         src="{{asset("assets/images/ensrv.jpg")}}">
                                ...
                                <div class="col-md-8 col-lg-8">
                                    <div class="hero-content-left ptb-100"
                                         style="border: #cccccc solid 2px; padding: 24px; border-radius: 5px;">
                                        ...
                                        <form class="form-horizontal" method="post" action="{{route('auth.login')}}">
                                            ...
                                            <div class="container">
                                                ...
                                                <div class="grid-wrapper row">
                                                    <label for="radio-card-1" class="radio-card col-md-4"
                                                           onclick="logvisable3()">
                                                        <input type="radio" @if($entity==3) checked
                                                               @endif name="company_id" value="3" id="radio-card-1"/>
                                                    ...
                                                    <label for="radio-card-3" class="radio-card col-md-4"
                                                           onclick="logvisable1()">
                                                        <input type="radio" @if($entity==1) checked
                                                               @endif name="company_id" value="1" id="radio-card-3"/>
                                                        <div class="card-content-wrapper ">
                                                            <span class="check-icon"></span>
                                                    ...
                                                    <label for="radio-card-2" class="radio-card col-md-4"
                                                           onclick="logvisable2()">
                                                        <input type="radio" @if($entity==2) checked
                                                               @endif name="company_id" value="2" id="radio-card-2"/>
                                                        <div class="card-content-wrapper">
                                                            <span class="check-icon"></span>
                                                            <div class="card-content">
                                                                <img
                                            ...
                                            <!-- /.container -->
                                            <div
                                                style="width: 400px; margin: auto; @isset($entity) display: block @else display: none @endisset "
                                                id="logform">
                                                ...
                                                <div class="form-group row mt-4">
                                                    <div class="col-sm-12 text-center">
                                                        <button class="btn w-100 waves-effect waves-light" type="submit"
                                                                style="background-color: #3a54a8; color: white">Login
                                                        </button>
                                                    </div>
                                                </div>
                                                <div id="join">
                                                    <p class="text-left">
                                                        New to <img class="img-fluid d-inline" style="width: 70px"
                                                                    src="{{asset("assets/images/hr360.png")}}">
                                                        Platform? <a class=""
                                                                     href="{{route('register',['entity'=>$entity])}}">
                                                            Join Now</a>
                                                    </p>
                                                    <p class="text-left">
                                                        <a class="" href="{{route('forget.password.get')}}">Forget
                                                            Password</a>
                                                    </p>
                                                </div>
                                            </div>
