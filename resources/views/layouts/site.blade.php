...
@if ($currentRouteName !== 'login' && $currentRouteName !== 'hh' && $currentRouteName !== 'register' && $currentRouteName !== 'forget.password.get' && $currentRouteName !== 'reset.password.get')

    <div class="wrapper" dir="rtl">
        <header class="top-header">
            <nav class=" navbar-expand gap-3 mt-3 mb-3">
                <div class="top-navbar-right ms-auto">
                    <ul class="navbar-nav align-items-center">
                        <li class="nav-item dropdown dropdown-user-setting">
                                ...
                                <div class="user-setting">
                                    <div class="d-flex flex-row align-items-center gap-2 ">
                                        <div class="" id="textContainer"
                                             style="width: 100%; height: max-content; overflow: hidden;text-align: right; color: black">
                                            <h6 class="mb-0 dropdown-user-name">{{auth('employee')->user()->empName}}</h6>
                                        </div>
                                        <div class="image-containerr">
                                            <img
                                                src="{{asset("assets/images/employees")}}/{{auth('employee')->user()->image}}"
                                                alt="" class="rounded-circle" width="54" height="54">
                                            <div class="edit-icon" style="color: black">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end" dir="ltr">
                                <li>
                                    <a class="dropdown-item" href="{{route('employee.edit.photo')}}">
                                        <div class="d-flex align-items-center">
                                            <div class="">
                                                <ion-icon name="settings-outline"></ion-icon>
                                            </div>
                                            <div class="ms-3 ml-1"><span>Edit Photo</span></div>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <a class="dropdown-item">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-3 w-100">
                                                <form id="logoutt" action="{{route('logout')}}" method="post">
                                                    @csrf
                                                    <button class="btn"
                                                            style="background-color: transparent; width: 100%; height: 100%; text-align: left"
                                                            type="submit">
                                                        Log Out
                                                    </button>
                                                </form>
